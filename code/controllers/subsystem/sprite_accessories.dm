...
/datum/controller/subsystem/accessories/proc/setup_lists()
	...
	tails_list_spineless = init_sprite_accessory_subtypes(/datum/sprite_accessory/tails/spineless, add_blank = TRUE)[DEFAULT_SPRITE_LIST] // EffigyEdit Add - DNA Extensions
