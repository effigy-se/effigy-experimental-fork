...
#define SPRITE_ACCESSORY_SOLO_COLOR list(EXTERNAL_FRONT, EXTERNAL_ADJACENT, EXTERNAL_BEHIND)

#define SPRITE_ACCESSORY_DUAL_COLOR list(EXTERNAL_FRONT, EXTERNAL_FRONT_SECONDARY, EXTERNAL_ADJACENT, EXTERNAL_ADJACENT_SECONDARY, EXTERNAL_BEHIND, EXTERNAL_BEHIND_SECONDARY)
